...
public class EcomAppApplication {
	...
	CommandLineRunner start (ProductRepository productRepository){
		return args -> {
			...
			productRepository.save(new Product(null, "Machine ", 9000 ));
			productRepository.save(new Product(null, "Imprimante", 12000 ));
...
class SupplierController{
	...
	public String suppliers(Model model){
		ResponseEntity<PagedModel<Suppliers>> response=
				keycloakRestTemplate.exchange("http://localhost:8083/suppliers", HttpMethod.GET, null, new ParameterizedTypeReference<PagedModel<Suppliers>>() {
		});
